...
class Maze(tk.Tk, object):
    ...
    def _build_maze(self):
        ...
        # create ship
        ship1_center=origin + np.array([0, UNIT * 15])
        self.ship1 = self.canvas.create_rectangle(
            ship1_center[0] - 15, ship1_center[1] - 15,
            ship1_center[0] + 15, ship1_center[1] + 15,
            fill='yellow')
        
        ship2_center=origin + np.array([0,UNIT * 15])
    ...
    def reset(self):
        ...
        origin = np.array([20, 20])
        ship1_center=origin + np.array( [180, 0])
        self.ship1 = self.canvas.create_rectangle(
            ship1_center[0] - 15,ship1_center[1] - 15,
            ship1_center[0] + 15, ship1_center[1] + 15,
            fill='yellow')
        
        ship2_center=origin+ np.array( [ 0,180])
        self.ship2 = self.canvas.create_rectangle(
            ship2_center[0] - 15,ship2_center[1] - 15,
            ship2_center[0] + 15, ship2_center[1] + 15,
            fill='green')
    ...
    def step(self, action):
        s = self.canvas.coords(self.ship1)
        ...
        s_ = self.canvas.coords(self.ship1)  # next state
        # s_ = self.canvas.coords(self.ship2) 
